...
public sealed class RiskCalculatorTests
{
    ...
    public void BuildSnapshot_AggregatesTotals()
    {
        var risks = new List<PositionRisk>
        {
            new(Guid.NewGuid(), "AAPL", Currency.USD, TradeSide.Buy, 100,
                50m, 55m, 500m, 500m, 100m, 100m, false, 1.0, null, null, null, null, null, null),
            new(Guid.NewGuid(), "MSFT", Currency.USD, TradeSide.Buy, 50,
                200m, 210m, 500m, 500m, -50m, -50m, false, 1.0, null, null, null, null, null, null),
        };
    ...
    private static PositionRisk MakeRisk(bool isStale) =>
        new(Guid.NewGuid(), "AAPL", Currency.USD, TradeSide.Buy, 100,
            50m, 55m, 500m, 500m, 0m, 0m, isStale, isStale ? 10.0 : 1.0, null, null, null, null, null, null);
}
